		...
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--account">
				...
				<ul class="footer-nav__list">
					...
					<li class="footer-nav__item">
						<a href="http://localhost/CSE470/model/customer/my_account.php?my_orders" class="footer-nav__link">Track an order</a>
					</li>
					<li class="footer-nav__item">
						<a href="http://localhost/CSE470/model/customer/my_account.php?edit_account" class="footer-nav__link">Update information</a>
					</li>
				</ul>
			</div>
