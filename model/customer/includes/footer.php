		...
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--info">
				...
				<ul class="footer-nav__list">
					...
					<li class="footer-nav__item">
						<a href="http://localhost/CSE470/controller/index.php" class="footer-nav__link">Local stores</a>
					</li>
					<li class="footer-nav__item">
			...
			<div class="footer-nav__col footer-nav__col--whybuy">
				...
				<ul class="footer-nav__list">
					...
					<li class="footer-nav__item">
						<a href="view_store.php" class="footer-nav__link">Secure shipping</a>
					</li>
					<li class="footer-nav__item">
			...
			<div class="footer-nav__col footer-nav__col--account">
				...
				<ul class="footer-nav__list">
					...
					<li class="footer-nav__item">
						<a href="http://localhost/CSE470/controller/customer/my_account.php?my_orders" class="footer-nav__link">Track an order</a>
					</li>
					<li class="footer-nav__item">
						<a href="http://localhost/CSE470/controller/customer/my_account.php?edit_account" class="footer-nav__link">Update information</a>
					</li>
				</ul>
			</div>
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:+8801643831573">+8801751777612</a>
				</div>
				<div class="email">
					Email:
